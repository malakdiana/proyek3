                ...
                <div class="card">
                    <div class="card-header">
                        <div class="pull-right">
                                <a href="javascript:void(0);" class="btn btn-success float-right" data-toggle="modal" data-target="#Modal_Import" style="margin: 5px; padding: 5px"><span class="fa "></span>Import</a></div>
                        <div class="pull-right">
                                <a href="javascript:void(0);" class="btn btn-success float-right" onclick="showModal()" style="margin: 5px; padding: 5px"><span class="fa fa-plus" ></span> Add</a>
                        </div>
                            ...
                            <div class="form-group col-lg-12 row" id="row1">
                                <div class="form-group col-lg-12 row">
                                    <div class="col-12">
                                        ...
                                        <input type="file" name="fileku" id="fileku" class="dropify form-control" data-height="100" required>
                                    </div>
                                </div>
...
<script type="text/javascript">
    $(document).ready(function(){
        ...
        $('#formimport').on('submit', function(event){
                        ...
                        $.ajax({
                            url:"<?php echo site_url('Alternatif/import') ?>",
                            method:"POST",
                            ...
                            success:function(data){
                                Swal.fire({
                                    type: 'success',
                                    title: 'Berhasil Import Alternatif',
